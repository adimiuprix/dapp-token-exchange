...
describe("Exchange", () => {
  let exchange, deployer, feeAccount, token1, token2, accounts, user1, user2;
  ...
  beforeEach(async () => {
    ...
    token1 = await Token.deploy("DAPP Univer", "DAPP", "1000000")
  ...
  describe('Depositing Tokens', () => {
    ...
    describe("Success", () => {
      ...
      it('emits a Deposit event', async () => {
        const eventlog = result.events[1]; // 2 events are emmitted
